...
# =========================================================
dirs <- list(
    "40m"  = "D:/DP/250908_chomoutovska_bc_data/data_dplomk/plochy_dron/40m",
    "80m"  = "D:/DP/250908_chomoutovska_bc_data/data_dplomk/plochy_dron/80m",
    "120m" = "D:/DP/250908_chomoutovska_bc_data/data_dplomk/plochy_dron/120m"
)
...
# =========================================================
asd_dir <- "D:/DP/250908_chomoutovska_bc_data/data_dplomk/ASD/asd_output_filtered/abs95_output"
ASD_LABEL <- "0.25m (ASD)"

# =========================================================
# 3) Output folder
# =========================================================
output_dir <- "D:/DP/250908_chomoutovska_bc_data/data_dplomk/plochy_dron/vysledky/absolute"
...
metrics_per_height <- raster_summary %>%
    ...
    mutate(
        ...
        MAE_pct_median  = ifelse(abs(ASD_median) > 1e-9, abs_err_median / ASD_median * 100, NA_real_),
        Bias_pct_median = ifelse(abs(ASD_median) > 1e-9, bias_median    / ASD_median * 100, NA_real_)
    )
...
#     BOXPLOTY: Každý boxplot obsahuje VŠECHNY pixely ze všech
#     rasterů daného povrchu ve dané výšce
# =========================================================
all_data <- bind_rows(
    raster_data,
