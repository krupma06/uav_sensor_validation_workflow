...
input_folder = Path(r"Put/Your/ASD/Input/Here") # <-- CHANGE THIS to your input folder path
output_folder = Path(r"Put/Your/ASD/Output/Here") # <-- CHANGE THIS to your output folder path
